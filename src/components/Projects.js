    ...
    <div className="container">
      <div className="row" style={{padding: '20px'}}>
        ...
        <div className="col s4">
          <div className="card">
            <div className="card-image waves-effect waves-block waves-light">
              <img className="activator" src='https://tb831.github.io/images/todo.png' alt="me"/>
            </div>
            <div className="card-action center">
      ...
      <div className="row">
        <div className="col s4">
          <div className="card">
            <div className="card-image">
              <img src='https://tb831.github.io/images/reactLogo.png' alt="me"/>
            </div>
            <div className="card-content center">
              <h4>Concentration Cards</h4>
        ...
        <div className="col s4">
          <div className="card">
            <div className="card-image">
              <img src='https://tb831.github.io/images/brain.png' alt="me"/>
            </div>
            <div className="card-content center">
              <h4>Concentration Cards</h4>
        ...
        <div className="col s4">
          <div className="card">
            <div className="card-image">
              <img src='https://tb831.github.io/images/chatbot.jpg' alt="me"/>
            </div>
            <div className="card-content center">
              <h4>Insurance Chatbot</h4>
